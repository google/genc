...
#ifndef GENC_CC_INTEROP_BACKENDS_ANDROID_WOLFRAM_ALPHA_HANDLER_H_
#define GENC_CC_INTEROP_BACKENDS_ANDROID_WOLFRAM_ALPHA_HANDLER_H_
...
#endif  // GENC_CC_INTEROP_BACKENDS_ANDROID_WOLFRAM_ALPHA_HANDLER_H_
