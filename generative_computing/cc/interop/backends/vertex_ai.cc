...
constexpr char kVertexAIModelGarden[] = "/vertex_ai/model_garden";
...
absl::StatusOr<v0::Value> VertexAI::Call(const v0::Value& input) {
...
absl::StatusOr<v0::Value> VertexAI::CreateRequest(std::string api_key,
                                                  std::string endpoint,
                                                  std::string json_request) {
  v0::Value request;
...
absl::Status VertexAI::SetInferenceMap(
    intrinsics::ModelInference::InferenceMap& inference_map) {
  inference_map[kVertexAIModelGarden] = [](v0::Value arg) { return Call(arg); };
