...
extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreateModelInference(  // NOLINT
    JNIEnv* env, jobject obj, jstring model_uri) {
  return GC_create_model_inference(env, model_uri);
}

extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreateModelInferenceWithConfig(  // NOLINT
...
extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreatePromptTemplate(  // NOLINT
    JNIEnv* env, jobject obj, jstring template_str) {
  return GC_create_prompt_template(env, template_str);
}

extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreateFallback(  // NOLINT
    JNIEnv* env, jobject obj, jobject list) {
  return GC_create_fallback(env, list);
}

extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreateConditional(  // NOLINT
...
extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreateCustomFunction(  // NOLINT
    JNIEnv* env, jobject obj, jstring fn_uri) {
  return GC_create_custom_function(env, fn_uri);
}

extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreateInjaTemplate(  // NOLINT
    JNIEnv* env, jobject obj, jstring template_str) {
  return GC_create_inja_template(env, template_str);
}

extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreateParallelMap(  // NOLINT
    JNIEnv* env, jobject obj, jbyteArray map) {
  return GC_create_parallel_map(env, map);
}

extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreateSerialChain(  // NOLINT
    JNIEnv* env, jobject obj, jobject list) {
  return GC_create_serial_chain(env, list);
}

extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreateStruct(  // NOLINT
    JNIEnv* env, jobject obj, jobject list) {
  return GC_create_struct(env, list);
}

extern "C" jbyteArray
Java_org_generativecomputing_authoring_Constructor_nativeCreateCall(  // NOLINT
