...
#ifndef GENERATIVE_COMPUTING_CC_INTRINSICS_REST_CALL_H_
#define GENERATIVE_COMPUTING_CC_INTRINSICS_REST_CALL_H_
...
#endif  // GENERATIVE_COMPUTING_CC_INTRINSICS_REST_CALL_H_
